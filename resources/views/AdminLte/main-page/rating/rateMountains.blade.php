    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Rate-Mountains</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="timeline timeline-inverse">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Average Rating Mountains</h3>
                                    ...
                                    <li class="item" style="height: 100px">
                                        ...
                                        <div class="product-info text-start">
                                            ...
                                            <a href="{{ url('/admin/mountains/detail?id=' . $mountain->id) }}"
                                                class="product-title truncate-text float-left">{{ $mountain->name }}</a>
                                            <br>
                                            <span class="badge ">
                                                <div class="d-flex justify-content-start star-rating-result mb-3 mt-1">
                                                    ...
                                                    @if ($mountain->averageRating == null)
                                                        <input type="hidden" name="whatever1" class="rating-value-result"
                                                            value="0">
                                                    @else
                                                        <input type="hidden" name="whatever1" class="rating-value-result"
                                                            value="{{ $mountain->averageRating }}">
                                                    @endif
                                                </div>
                                            </span>
