	...
	<div class="bg-image overflow-hidden" style="height: 100vh !important">
		...
		<div class="login-container d-flex flex-column justify-content-center align-items-center h-100">
			...
			<div class="login-card">
				<h3 class="display-8 mb-4 text-center text-hover">We will send password reset link to your email</h3>
				<form action="{{ route('password.email') }}" method="POST" class="forgotPasswordForm">
					@csrf
					<div class="form-group">
						<input id="username" name="username" type="text" class="form-control form-input" placeholder="Username" required>
					</div>
					
					<div class="form-group text-center">
						<button type="submit" class="btn-custom btn btn-primary py-2 px-4  d-xl-inline-block rounded-pill w-100 sign-in-button">Request</button>
					</div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    ...
                    text: response.status, // Sử dụng trạng thái từ response JSON để hiển thị thông báo
                    icon: 'success',
